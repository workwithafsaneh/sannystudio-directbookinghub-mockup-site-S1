...
<section class="page-head hero-photo">
  <img class="hero-photo-img" src="/images/reviews/reviews-hero-2.webp" alt="Coastal vacation rental deck at golden hour" loading="eager" decoding="async" fetchpriority="high">
  <div class="container">
