...
export const Route = createFileRoute("/properties/firelight-cottage")({
  head: () => ({
    meta: [
      { title: "Firelight Cottage \u2014 Princeville, Kauai, HI | Savage Vacations" },
      { name: "description", content: "Sleeps 6-8 in this 3-bedroom island home in Princeville, Kauai. Private hot tub, tropical garden, and a short drive to Hanalei Bay \u2014 book direct for zero service fees." },
      { property: "og:title", content: "Firelight Cottage \u2014 Princeville, Kauai, HI | Savage Vacations" },
      { property: "og:description", content: "A 3-bedroom island home in Princeville, Kauai, with a private hot tub, tropical garden, and an easy drive to Hanalei Bay. Book direct for zero service fees." },
    ...
    links: [{ rel: "stylesheet", href: "/css/prop-firelight.css" }],
  }),
  component: PropFirelightPage,
});
...
const html = `<script type="application/ld+json">
{
  ...
  "@type": "VacationRental",
  "name": "Firelight Cottage",
  "description": "A three-bedroom island home in Princeville, Kauai, Hawaii, with a private hot tub, tropical garden, and a short drive to Hanalei Bay.",
  "url": "https://www.savagevacations.com/properties/firelight-cottage",
...
<div class="container">
  <div class="breadcrumb-strip" style="margin-top:22px;">Home <span>/</span> Properties <span>/</span> Firelight Cottage</div>
</div>

<section class="page-head">
  <div class="container">
    <div class="eyebrow">Island Home &nbsp;·&nbsp; Sleeps 8</div>
    <h1>Firelight Cottage — Princeville, Kauai</h1>
    <div class="meta-row">
      <span class="rating-badge">★ 4.95 · 150 reviews</span>
      <span class="location">📍 Princeville, Kauai, Hawaii</span>
    </div>
  </div>
</section>
...
<div class="container gallery">
  <div class="gallery-grid">
    <div class="ph-photo main has-photo" onclick="openLightbox(0)"><img class="ph-photo-img" src="/images/properties/firelight/01-hot-tub-garden.webp" alt="Private hot tub in the tropical backyard" loading="eager" decoding="async" fetchpriority="high"></div>
    <div class="thumb-col">
      <div class="ph-photo has-photo" onclick="openLightbox(1)"><img class="ph-photo-img" src="/images/properties/firelight/02-living-room.webp" alt="Living room with rattan chairs" loading="lazy" decoding="async"></div>
      <div class="ph-photo has-photo" onclick="openLightbox(2)"><img class="ph-photo-img" src="/images/properties/firelight/03-kitchen.webp" alt="Green kitchen with garden view" loading="lazy" decoding="async"></div>
      <div class="ph-photo has-photo" onclick="openLightbox(3)"><img class="ph-photo-img" src="/images/properties/firelight/01-hot-tub-garden.webp" alt="Tropical garden hot tub, alternate view" loading="lazy" decoding="async"></div>
    </div>
...
<div class="container">
  <div class="stats-strip">
    <div class="stat-box"><div class="num">3</div><div class="lbl">Bedrooms</div></div>
    <div class="stat-box"><div class="num">2</div><div class="lbl">Bathrooms</div></div>
    <div class="stat-box"><div class="num">6–8</div><div class="lbl">Guests</div></div>
  </div>
  ...
  <div class="content-grid">
    <div>
      ...
      <section class="block">
        ...
        <p>Set on a quiet street in Princeville on Kauai's North Shore, Firelight Cottage is a three-bedroom island home surrounded by tropical garden. Vaulted wood-beamed ceilings, a wraparound lanai, and breezy indoor-outdoor living make it feel worlds away from a typical rental.</p>
        <p>Unwind in the private hot tub tucked into the garden, cook together in the light-filled kitchen, or spend the afternoon at Hanalei Bay, fifteen minutes down the road. This is a home for slow island mornings, golden-hour lanai dinners, and the kind of trip that has everyone already planning the next one.</p>
      </section>

      <section class="block timeline-section">
        <h2>A Day at Firelight Cottage</h2>
        <p class="section-sub">This is a home built around the rhythm of an island day — not just a place to sleep.</p>
        <div class="timeline">
          <div class="t-item">
            ...
            <p>Coffee on the lanai with the garden waking up around you.</p>
          </div>
          <div class="t-item">
            ...
            <p>A short drive to Hanalei Bay, back in time for lunch in the shade.</p>
          </div>
          <div class="t-item">
            <span class="t-icon"><svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="2.1"/><path d="M12 2.5c1.8 2 1.8 3.8 0 5.7-1.8-1.9-1.8-3.7 0-5.7zM12 21.5c1.8-2 1.8-3.8 0-5.7-1.8 1.9-1.8 3.7 0 5.7zM2.5 12c2-1.8 3.8-1.8 5.7 0-1.9 1.8-3.7 1.8-5.7 0zM21.5 12c-2-1.8-3.8-1.8-5.7 0 1.9 1.8 3.7 1.8 5.7 0z"/></svg></span>
            <span class="t-time">Evening</span>
            <p>Dinner from the open kitchen as the light turns gold over the garden.</p>
          </div>
          <div class="t-item">
            ...
            <p>The private hot tub, warm island air, and a sky full of stars.</p>
          </div>
        </div>
      </section>
      ...
      <section class="block">
        ...
        <div class="amenity-grid">
          ...
          <div class="amenity-card"><span class="a-icon"><svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="2.1"/><path d="M12 2.5c1.8 2 1.8 3.8 0 5.7-1.8-1.9-1.8-3.7 0-5.7zM12 21.5c1.8-2 1.8-3.8 0-5.7-1.8 1.9-1.8 3.7 0 5.7zM2.5 12c2-1.8 3.8-1.8 5.7 0-1.9 1.8-3.7 1.8-5.7 0zM21.5 12c-2-1.8-3.8-1.8-5.7 0 1.9 1.8 3.7 1.8 5.7 0z"/></svg></span>Tropical Garden</div>
          ...
          <div class="amenity-card"><span class="a-icon"><svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21.5V12"/><path d="M12 12c-2.3-2.8-6-2.6-8-.8 2.2.9 4 1 8 .8zM12 12c2.3-2.8 6-2.6 8-.8-2.2.9-4 1-8 .8zM12 12c-1.2-2.8-.8-5.6 1-7.7-2 .3-3.6 2.3-3.2 5 .5 1.6 1.3 2.3 2.2 2.7z"/></svg></span>Wraparound Lanai</div>
          ...
          <div class="amenity-card"><span class="a-icon"><svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M5 6.5l14 11M19 6.5l-14 11"/></svg></span>Air Conditioning</div>
        </div>
      </section>
      ...
      <section class="block">
        ...
        <div class="sleep-grid">
          <div class="sleep-card"><h4>Primary Suite</h4><p>1 King bed, en-suite bath, lanai access</p></div>
          <div class="sleep-card"><h4>Bedroom Two</h4><p>1 Queen bed, garden view</p></div>
      ...
      <section class="block host-card" id="host">
        <div class="host-avatar">KM</div>
        <div>
          <span class="host-badge">✓ Superhost</span>
          <h3>Hosted by Kalani M.</h3>
          <p class="host-meta">4.95 rating · Hosting since 2018 · Usually responds within an hour</p>
          <p class="host-blurb">"This is a family home before it's a rental — we planted every tree in that garden ourselves. We want guests to feel that."</p>
          <a class="btn btn-outline btn-sm" href="/#contact">Message Kalani</a>
        </div>
      </section>
      ...
      <section class="block">
        ...
        <div class="rules-box">
          ...
          <div>
            ...
            <ul>
              <li>25 min from Lihue Airport (LIH)</li>
              <li>10 min from Princeville town center</li>
              <li>Private driveway parking for 2 vehicles</li>
      ...
      <section class="block">
        <div class="attraction-grid">
          <div class="ph-photo attraction-card has-photo" style="align-items:flex-start"><img class="ph-photo-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/Ultimate%20Seafood%20Platter%20at%20Landry%27s%20Seafood%20House.jpg?width=600" alt="Fresh island seafood plate" loading="lazy" decoding="async">
            <span class="tag">Restaurant</span>
          </div>
          <div class="ph-photo attraction-card has-photo" style="align-items:flex-start"><img class="ph-photo-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/Inside%20Bridgehead%20Coffee%20Shop%20%2829685669166%29.jpg?width=600" alt="Garden cafe interior" loading="lazy" decoding="async">
            <span class="tag">Coffee</span>
          </div>
          <div class="ph-photo attraction-card has-photo" style="align-items:flex-start"><img class="ph-photo-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/Hanalei%20Beach%20at%20Sunset%20-%20Pacific%20Ocean%20-%20Kauai%20-%20Hawaii.jpg?width=600" alt="Hanalei Bay at sunset" loading="lazy" decoding="async">
            <span class="tag">Park</span>
          </div>
        </div>
        <div class="attraction-grid" style="margin-top:12px;">
          <div class="attraction-caption">
            <span class="a-title">Kauai Plate Lunch Co.</span><span class="a-sub">Local Hawaiian plates · 10 min drive</span>
          </div>
          <div class="attraction-caption">
            <span class="a-title">Princeville Garden Café</span><span class="a-sub">Coffee &amp; acai bowls · 8 min drive</span>
          </div>
          <div class="attraction-caption">
            <span class="a-title">Hanalei Bay</span><span class="a-sub">Beach &amp; sunset views · 15 min drive</span>
          </div>
        </div>
      </section>
      ...
      <section class="block">
        <h2>Location</h2>
        <div class="map-box"><iframe title="Map" src="https://www.google.com/maps?q=Princeville,+Kauai,+Hawaii&output=embed&z=12" loading="lazy" referrerpolicy="no-referrer-when-downgrade" allowfullscreen></iframe></div>
        <p class="map-caption"><strong>Princeville, Kauai, Hawaii</strong> · Exact address shared after booking</p>
      </section>

      <section class="block">
        <div class="reviews-head">
          <h2 style="margin:0;">Guest reviews <span style="font-size:1rem; color:var(--maroon);">★ 4.95 (150)</span></h2>
          <a href="/reviews">See all 150 reviews →</a>
        </div>
        <div class="review-grid">
          <div class="review-card">
            <div class="stars">★★★★★</div>
            <p>"The garden and hot tub sold us the second we walked in. We spent every evening out there."</p>
            <div class="who"><strong>Melissa Choi</strong><br>March 2026</div>
          </div>
          <div class="review-card">
            <div class="stars">★★★★★</div>
            <p>"Perfectly located for Hanalei Bay and so quiet at night. Kalani checked in without being intrusive."</p>
            <div class="who"><strong>Ethan Alofa</strong><br>February 2026</div>
          </div>
          <div class="review-card">
            <div class="stars">★★★★★</div>
            <p>"Spacious, spotless, and the kitchen had everything we needed for a week with the kids."</p>
            <div class="who"><strong>Rachel Kim</strong><br>January 2026</div>
          </div>
        </div>
      </section>
      ...
      <section class="block">
        ...
        <details class="faq-item">
          <summary>How far is Hanalei Bay?</summary>
          <p>About a 15-minute drive, with several smaller beaches and Queen's Bath even closer.</p>
        </details>
        <details class="faq-item">
          <summary>Is the hot tub private?</summary>
          <p>Yes — the garden hot tub is exclusively for guests staying at Firelight Cottage.</p>
        </details>
        <details class="faq-item">
          <summary>Do you provide beach gear?</summary>
          <p>Beach chairs, towels, and coolers are provided. Snorkel gear is available on request.</p>
        </details>
        <details class="faq-item">
    ...
    <aside class="booking-card" id="booking">
      <div class="booking-head">
        <div class="ph-photo booking-thumb has-photo"><img class="ph-photo-img" src="/images/properties/firelight/01-hot-tub-garden.webp" alt="Firelight Cottage" loading="lazy" decoding="async"></div>
        <div>
          <div class="booking-price">$415 <span>/ night</span></div>
          <div class="booking-rating">★ 4.95 (150)</div>
        </div>
      </div>
      ...
      <div class="price-lines">
        <div><span id="nightsLabel">$415 × 4 nights</span><span id="subtotalVal">$1,660</span></div>
        <div><span>Cleaning fee</span><span>$175</span></div>
        <div><span>Service fee</span><span>$0</span></div>
        <div class="total"><span>Total</span><span id="totalVal">$1,835</span></div>
      </div>

      <div class="trust-row">
        🔒 Secure checkout &nbsp;·&nbsp; ✓ Best-rate guarantee<br>↺ Free cancellation, 30 days
      </div>
      <a class="ask-link" href="/#contact">Have a question? Ask Kalani</a>
    </aside>
  </div>
</div>
...
<div class="mobile-bar">
  <div><strong>$415</strong> <span style="font-size:.78rem; color:var(--ink-faint);">/ night · ★4.95</span></div>
...
const script = `let checkin = null, checkout = null;
  ...
  const galleryPhotos = [
    { v: '--img-firelight-01', label: 'Private hot tub in the tropical backyard' },
    { v: '--img-firelight-02', label: 'Living room with rattan chairs' },
    { v: '--img-firelight-03', label: 'Green kitchen with garden view' },
    { v: '--img-firelight-01', label: 'Tropical garden hot tub, alternate view' }
  ];
  let lightboxIndex = 0;
